        ...
        <div className='flex flex-wrap gap-4 my-6'>
          ...
          <div className='flex gap-2 h-fit'>
            ...
            {result.lyric === ''
              ...
              <button 
                className={`
                  flex py-2 px-2 gap-1 tablet:px-5 rounded-full  items-center w-fit h-fit
              ...
              >
                ...
                {/* Google Fonts Icons */}
                <svg className={`${isLoading?'fill-zinc-400':'fill-zinc-600'} w-[18px] h-[18px] mobileL:w-[24px] mobileL:h-[24px]`} xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960">
