...
export default function MypageTabs({ type }: { type: string }) {
    ...
    <div className="flex mb-5 gap-2 overflow-x-auto border-b border-neutral-300 " role="tablist" aria-label="tab options">
        ...
        className={`flex items-center h-min px-4 py-2 text-xl border-b-2
            ...
            `}
        href={{ pathname: '/mypage/chart' }}
        scroll={false}
        aria-disabled={type==='chart'}
        >
        ...
        className={`flex items-center h-min px-4 py-2 text-xl border-b-2
            ...
            `}
        href={{ pathname: '/mypage/readafter' }}
        scroll={false}
        aria-disabled={type==='readafter'}
        >
        {/* Google Fonts Icons */}
