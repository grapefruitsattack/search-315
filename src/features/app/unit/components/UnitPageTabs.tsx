...
export default function UnitPageTabs({ type }: { type: string }) {
    ...
    return(
    <div className="flex mb-5 gap-0  " role="tablist" aria-label="tab options">
        <Link 
          className={`flex items-center  px-4 py-2 text-xl rounded-t-2xl
        ...
        >
        <svg className="rounded" xmlns="http://www.w3.org/2000/svg" viewBox="-0.5 0 24 24" width="24" height="24">
        ...
        >
        {/* Google Fonts Icons */}
        <svg className="rounded px-[0.5px]" xmlns="http://www.w3.org/2000/svg" height="24px" width="26px" viewBox="10 -960 960 960">
