  ...
  <>
    ...
    <section className="">
      <div>
        ...
        <div className='flex w-fit lg:text-base text-sm font-sans text-slate-600 '>
          <a className="">{releaseDate}</a>
          <a className="">{'更新'}</a>
        </div>

        <div className='flex flex-wrap relative text-xs tablet:text-sm font-mono text-white gap-1 mb-2'>
          {voiceStateName===''
            ?<></>
          ...
          <div 
            ...
            >
              <button
                ...
                fill-red-500 hover:fill-red-50 active:scale-90
