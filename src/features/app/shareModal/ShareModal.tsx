...
export const ShareModal = (
  { shareUrl, shareSiteTitle, shareText, pass, buttonText }
  : { shareUrl: string, shareSiteTitle: string, shareText: string, pass: string, buttonText: string }
) => {
    //モーダル
