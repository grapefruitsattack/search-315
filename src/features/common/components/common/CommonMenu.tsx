...
import { BookOpen, MessageSquareMore, ExternalLink, MessageCircleQuestion, Info, Sparkle } from 'lucide-react';
        ...
        <div className='ml-2'>
          ...
          >
            <SelectTrigger className="w-[170px] h-[35px]">
              <SelectValue placeholder={'ユニットを選ぶ'} />
            </SelectTrigger>
            <SelectContent>
