...
export default function IdolLabel({ singingInfoId }: { singingInfoId: string }): JSX.Element{
    ...
    return(<div className={`justify-center border-[3px] rounded-full p-1 border-`+unitId}>
        <p className={``}>{name}</p>
