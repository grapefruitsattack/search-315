...
export default function CategoryBadge({ id, size }: { id: string, size: string }) {
    ...
    let textColor: string = 'text-teal-500';
    ...
    switch (id) { 
        ...
        case CATEGORY.connectWithStage.id:
            ...
            symbolStrokeColor = 'stroke-white';
