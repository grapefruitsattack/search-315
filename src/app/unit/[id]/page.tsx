...
const Units = async ({
  ...
  const pageCategory = (await cookieStore).get('pageCategory')?.value||'';
  ...
  <Suspense>
    ...
    <article className=" pb-96 font-sans ">
      <div className='lg:max-w-[1050px] lg:m-auto pb-10'>
      ...
      <div 
        className="flex flex-col mt-6 gap-10
          px-0 mobileM:px-1 mobileL:px-2 tablet:px-4 tablet:px-8 lg:px-8
        "
      >
        {/* 楽曲 */}
        <section
